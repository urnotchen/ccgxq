...
class OrderController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->renderPartial('index', [
            'list' => \frontend\models\Order::getOrderList(),
        ]);
    }
    ...
    public function actionView($id)
    {
        ...
        $model->work_time = Order::enum('work_time')[$model->work_time];
    ...
    public function actionBook($id){
        ...
        if($order->status == Order::STATUS_NORMAL){
            return $this->renderPartial('book',[
                'morning_time' => $order->morning_time,
                'afternoon_time' => $order->afternoon_time,
            ]);
        }else if($order->status == Order::STATUS_STOP){
            return $this->renderPartial('book_stop');
