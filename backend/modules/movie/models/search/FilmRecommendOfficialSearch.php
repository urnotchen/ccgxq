 ...
 */
class FilmRecommendOfficialSearch extends FilmRecommendOfficial
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'movie_id', 'created_at', 'created_by', 'updated_at', 'updated_by', 'sequence'], 'integer'],
        ];
    }
    ...
    {
        $query = FilmRecommendOfficial::find();
